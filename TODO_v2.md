...
5. ~~**🟡 Низкий:** Добавить автообновление ipset~~ ✅ ВЫПОЛНЕНО (ipset_updater.rs, IpsetSettings.svelte)
6. ~~**🟡 Низкий:** Добавить hosts update для Discord~~ ✅ ВЫПОЛНЕНО (hosts_manager.rs, HostsSettings.svelte)
