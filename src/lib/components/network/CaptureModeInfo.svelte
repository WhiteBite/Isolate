...
<div class="mt-2">
  ...
  <button
    ...
    class="flex items-center gap-1.5 text-xs text-zinc-400 hover:text-zinc-400 transition-colors"
  >
    <svg 
    ...
    <div class="mt-2 p-3 bg-zinc-900/50 rounded-lg border border-white/5 text-xs space-y-3 animate-in fade-in slide-in-from-top-1 duration-200">
      ...
      <div class="space-y-1.5">
        ...
        <div class="pl-6 flex flex-wrap gap-1.5">
          <span class="px-1.5 py-0.5 bg-emerald-500/10 text-emerald-400 rounded text-[10px]">✓ Все приложения</span>
          <span class="px-1.5 py-0.5 bg-emerald-500/10 text-emerald-400 rounded text-[10px]">✓ Игры</span>
          <span class="px-1.5 py-0.5 bg-emerald-500/10 text-emerald-400 rounded text-[10px]">✓ UDP трафик</span>
        </div>
      </div>
      ...
      <div class="space-y-1.5">
        ...
        <div class="pl-6 flex flex-wrap gap-1.5">
          ...
          <span class="px-1.5 py-0.5 bg-amber-500/10 text-amber-400 rounded text-[10px]">⚠ Не все приложения</span>
        </div>
      </div>
      ...
      <div class="p-2 bg-amber-500/5 border border-amber-500/10 rounded">
        <p class="text-amber-400 leading-relaxed">
