    ...
    <div class="flex items-center justify-between">
      <div>
        <div class="flex items-center gap-3">
          <h1 class="text-3xl font-bold text-white tracking-tight">{t('orchestra.title')}</h1>
          {#if isDemoMode}
        ...
        <p class="text-sm text-zinc-400 mt-2">{t('orchestra.subtitle')}</p>
      </div>
